...
public class LinkBuilder {
	...
	public static final String _photoLinkFormat = Common.DOMAIN_FILE + "/ik/load/%s/photo/%s";
	public static final String _photoResizeLinkFormat = Common.DOMAIN_FILE + "/ik/load/%s/photo/%s?size=%d";
	public static final String _shareLinkFormat = Common.DOMAIN_FILE + "/ik/load/%s/share/%s";
	...
	public static final String _mapTileLink = Common.DOMAIN_FILE + "/ik/load/tile/%d";

	public static String buildMapTile(long id) {
		String link = "";
		if (id > 0) {
			link = String.format(_mapTileLink, id) + "?size=1024";
		}
