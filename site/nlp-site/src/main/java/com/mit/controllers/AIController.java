...
public class AIController {
	...
	@RequestMapping(value = "/labeling", method = RequestMethod.POST)
	@ResponseBody
	public ApiResponse<SentimentPredictResponse> labelingComment(HttpServletRequest req, @RequestBody CommentLabelingBody body) {
		sentimentService.labeling(body);
